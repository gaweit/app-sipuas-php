                      ...
                      <thead>
                                    ...
                                    <?php
                                         $id_user=$_SESSION['id_user'];
                                                    $query = mysql_query("SELECT * FROM arsip
                                                    INNER JOIN user on user.id_user = arsip.id_user
                                    ...
                                    <tbody>
                                        ...
                                        <a href="download_administrator.php?filename=<?=$data['file']?>">
                                        <button type="button" rel="tooltip" class="btn btn-icon btn-primary">
                                        <i class="fa fa-download"> Unduh</i>
                                        </button></a>
                                                         <a  href ="#edit" data-toggle="modal" data-id="<?php echo $data['id_arsip'];?>" 
                                                         data-target="#edit"><button type="button" rel="tooltip" class="btn btn-icon btn-success">
                                                            <i class="fa fa-edit"> Ubah</i>
                                                        </button></a>
                                                     
  <a  href="#" onclick="confirm_modal('proses/administrator/hapus_arsip_administrator.php?id=<?php echo $data['id_arsip'];?>');">
...
include("proses/modal/arsip_administrator.php");
