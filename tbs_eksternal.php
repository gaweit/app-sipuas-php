              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h4>Tabel Data TBS Eksternal</h4>
                  </div>
                    ...
                    <button class="btn btn-icon btn-info" data-toggle="modal" data-target="#tambah">
                      ...
                      <thead>
                                    ...
                                    <?php
                                                    ...
                                                    $query = mysql_query("SELECT * FROM tbs_eksternal ORDER BY tgl_eks ASC");
                                                $no = 1;
                                    ...
                                    <tbody>
                                        <tr>
                                                ...
                                                <td> <?php echo $data['ket_eks']; ?></td>
                                               
                                                <td class="td-actions text-center">
                                                         <a  href ="#edit" data-toggle="modal" data-id="<?php echo $data['id_eks'];?>" 
                                                         data-target="#edit"><button type="button" rel="tooltip" class="btn btn-icon btn-success">
                                                            <i class="fa fa-edit"> Ubah</i>
                                                        </button></a>
                                                     
  <a  href="#" onclick="confirm_modal('proses/administrator/hapus_eks.php?id=<?php echo $data['id_eks'];?>');">
