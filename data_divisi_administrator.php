                                    ...
                                    <tbody>
                                        <tr>
                                                ...
                                                <td class="td-actions text-center">
                                                         <a  href ="#edit" data-toggle="modal" data-id="<?php echo $data['id_divisi'];?>" 
                                                         data-target="#edit"><button type="button" rel="tooltip" class="btn btn-icon btn-success">
                                                            <i class="fa fa-edit"> Ubah</i>
                                                        </button></a>
                                                     
  <a  href="#" onclick="confirm_modal('proses/administrator/hapus_divisi_administrator.php?id=<?php echo $data['id_divisi'];?>');">
...
include("proses/modal/divisi.php");
