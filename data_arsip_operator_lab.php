...
<body>
                    ...
                    <button class="btn btn-icon btn-info" data-toggle="modal" data-target="#tambah">
                      ...
                      <thead>
                                    ...
                                    <tbody>
                                        ...
                                        <a href="download_arsip_operator_lab.php?filename=<?=$data['file']?>">
  ...
  <a  href="#" onclick="confirm_modal('proses/operator_lab/hapus_arsip_operator_lab.php?id=<?php echo $data['id_arsip'];?>');">
...
include("proses/modal/arsip.php");
