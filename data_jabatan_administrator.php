                                    ...
                                    <tbody>
                                        <tr>
                                                ...
                                                <td class="td-actions text-center">
                                                         <a  href ="#edit" data-toggle="modal" data-id="<?php echo $data['id_jabatan'];?>" 
                                                         data-target="#edit"><button type="button" rel="tooltip" class="btn btn-icon btn-success">
                                                            <i class="fa fa-edit"> Ubah</i>
                                                        </button></a>
                                                     
  <a  href="#" onclick="confirm_modal('proses/administrator/hapus_jabatan_administrator.php?id=<?php echo $data['id_jabatan'];?>');">
...
include("proses/modal/jabatan.php");
