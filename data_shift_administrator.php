                      ...
                      <thead>
                                    ...
                                    <tbody>
                                        <tr>
                                                ...
                                                <td>
                                                    <img alt="image" src="assets2/<?php echo $data['keterangan']?>" width="100">
                                                  </td>
                            
                                      
                                                <td class="td-actions text-center">
                                                         <a  href ="#edit" data-toggle="modal" data-id="<?php echo $data['id_shift'];?>" 
                                                         data-target="#edit"><button type="button" rel="tooltip" class="btn btn-icon btn-success">
                                                            <i class="fa fa-edit"> Ubah</i>
                                                        </button></a>
                                                     
  <a  href="#" onclick="confirm_modal('proses/administrator/hapus_shift_administrator.php?id=<?php echo $data['id_shift'];?>');">
...
include("proses/modal/shift.php");
