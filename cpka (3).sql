...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 13, 2023 at 08:42 AM
...
CREATE TABLE `bantingan` (
  ...
  `tgl_ban` date NOT NULL,
  `tippler_cap_5ton` varchar(50) NOT NULL,
  `sfb_conveyor01` varchar(50) NOT NULL,
  `sfb_conveyor02` varchar(50) NOT NULL,
  `threser01` varchar(50) NOT NULL,
  `threser02` varchar(25) NOT NULL,
  `threser03` varchar(50) NOT NULL,
  `discharge_conveyor01` varchar(50) NOT NULL,
  `discharge_conveyor02` varchar(50) NOT NULL,
  `discharge_conveyor03` varchar(50) NOT NULL,
  `eb_conveyor` varchar(50) NOT NULL,
  `ket` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `bantingan`
--

INSERT INTO `bantingan` (`id_bantingan`, `tgl_ban`, `tippler_cap_5ton`, `sfb_conveyor01`, `sfb_conveyor02`, `threser01`, `threser02`, `threser03`, `discharge_conveyor01`, `discharge_conveyor02`, `discharge_conveyor03`, `eb_conveyor`, `ket`) VALUES
(1, '2023-02-01', 'normal', 'normal', 'normal', 'normal', 'normal', 'normal', 'normal', 'normal', 'normal', 'normal', 'siap');
...
CREATE TABLE `boiler` (
  ...
  `dust_ca/l01` varchar(25) NOT NULL,
  `dust_ca/l02` varchar(25) NOT NULL,
...
CREATE TABLE `klarifikasi` (
  ...
  `vibrating_screen01` varchar(50) NOT NULL,
  `vibrating_screen02` varchar(50) NOT NULL,
  `vibrating_screen03` varchar(50) NOT NULL,
  `vibrating_screen04` varchar(50) NOT NULL,
  `cop_ssc_01` varchar(50) NOT NULL,
  `cop_ssc_02` varchar(50) NOT NULL,
  `cop_ssc_03` varchar(50) NOT NULL,
  `cop_ssc_04` varchar(50) NOT NULL,
  `sand_cyclone_ssc01` varchar(50) NOT NULL,
  `sand_cyclone_ssc02` varchar(50) NOT NULL,
  `vacum_dryer_w/c_pump_01` varchar(50) NOT NULL,
  `pop_01` varchar(50) NOT NULL,
  `pop_02` varchar(50) NOT NULL,
  `dotp_01` varchar(50) NOT NULL,
  `dotp_02` varchar(50) NOT NULL,
  `flow_meter` varchar(50) NOT NULL,
  `orp_01` varchar(50) NOT NULL,
  `orp_02` varchar(50) NOT NULL,
  `slugepump_01` varchar(50) NOT NULL,
  `slugedump_02` varchar(50) NOT NULL,
  `decanter_01` varchar(50) NOT NULL,
  `decanter_02` varchar(50) NOT NULL,
  `dcc` varchar(50) NOT NULL,
  `heavyphase_p01` varchar(50) NOT NULL,
  `heavyphase_p02` varchar(50) NOT NULL,
  `lighphase_p01` varchar(50) NOT NULL,
  `lighphase_p02` varchar(50) NOT NULL,
  `sluge_s01` varchar(50) NOT NULL,
  `sluge_s02` varchar(50) NOT NULL,
  `sluge_s03` varchar(50) NOT NULL,
  `rsp_01_tfp_2` varchar(50) NOT NULL,
  `rsp_02_tfp_2` varchar(50) NOT NULL,
  `sop_01` varchar(50) NOT NULL,
  `sop_02` varchar(50) NOT NULL,
  `hwp_01` varchar(50) NOT NULL,
  `hwp_02` varchar(50) NOT NULL,
  `compresor` varchar(25) NOT NULL,
  `fat_pit` varchar(25) NOT NULL,
  `oiltank_1` varchar(25) NOT NULL,
  `oiltank_2` varchar(25) NOT NULL,
  `buffertank_decanter` varchar(25) NOT NULL,
  `bt_ss` varchar(25) NOT NULL,
  `recovery_tank` varchar(25) NOT NULL,
  `sluge_tank` varchar(25) NOT NULL,
  `ket` text NOT NULL,
  `tanggal` date NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `nut_kernel` (
  ...
  `hcbc` int(11) NOT NULL,
  `fcf_a/l_01` int(11) NOT NULL,
  `fcf_a/l_02` int(11) NOT NULL,
  `npd_01` int(11) NOT NULL,
  `npd_02` varchar(25) NOT NULL,
  `inclened_wnc_01` varchar(25) NOT NULL,
  `inclened_wnc_02` varchar(25) NOT NULL,
  `wet_ne_01` varchar(25) NOT NULL,
  `wet_ne_02` varchar(25) NOT NULL,
  `nut_df_a/l01` varchar(25) NOT NULL,
  `primari_wf_a/l01` varchar(25) NOT NULL,
  `primari_wf_a/l02` varchar(25) NOT NULL,
  `scondary_wf_a/l01` varchar(25) NOT NULL,
  `scondary_wf_a/l02` varchar(25) NOT NULL,
  `nut_hopper` varchar(25) NOT NULL,
  `rm_01` varchar(25) NOT NULL,
  `rm_02` varchar(25) NOT NULL,
  `rm_03` varchar(25) NOT NULL,
  `rm_04` varchar(25) NOT NULL,
  `cmc_01` varchar(25) NOT NULL,
  `cmc_02` varchar(25) NOT NULL,
  `cms` varchar(25) NOT NULL,
  `hp01_line1` varchar(25) NOT NULL,
  `hp02_line1` varchar(25) NOT NULL,
  `hp03_line1` varchar(25) NOT NULL,
  `hp01_line2` varchar(25) NOT NULL,
  `hp02_line2` varchar(25) NOT NULL,
  `hp03_line2` varchar(25) NOT NULL,
  `wetshell_c` varchar(25) NOT NULL,
  `wetshell_tf` varchar(25) NOT NULL,
  `wkc_01` varchar(25) NOT NULL,
  `wkc_02` varchar(25) NOT NULL,
  `wkc_03` varchar(25) NOT NULL,
  `wke_01` varchar(25) NOT NULL,
  `wke_02` varchar(25) NOT NULL,
  `wkdc` varchar(25) NOT NULL,
  `kds_hf01` varchar(25) NOT NULL,
  `kds_hf02` varchar(25) NOT NULL,
  `kds_hf03` varchar(25) NOT NULL,
  `bottom_kc` varchar(25) NOT NULL,
  `dry_ktf` varchar(25) NOT NULL,
  `kbs_01` varchar(25) NOT NULL,
  `ltds_al1` varchar(25) NOT NULL,
  `ltds_al2` varchar(25) NOT NULL,
  `kernel_silo1` varchar(25) NOT NULL,
  `kernel_silo2` varchar(25) NOT NULL,
  `kernel_silo3` varchar(25) NOT NULL,
  `tanggal` date NOT NULL,
  `ket` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `rebusan_proses` (
  ...
  `tanggal` date NOT NULL,
  `fruit_tc01` varchar(20) NOT NULL,
  `fruit_tc02` varchar(20) NOT NULL,
  `sterilizer01` varchar(20) NOT NULL,
  `sterilizer02` varchar(20) NOT NULL,
  `sterilizer03` varchar(20) NOT NULL,
  `drawbrige01` varchar(20) NOT NULL,
  `drawbrige02` varchar(20) NOT NULL,
  `drawbrige03` varchar(20) NOT NULL,
  `power_pack1` varchar(20) NOT NULL,
  `power_pack2` varchar(20) NOT NULL,
  `power_pack3` varchar(20) NOT NULL,
  `hut01` varchar(20) NOT NULL,
  `hut02` varchar(20) NOT NULL,
  `hut03` varchar(20) NOT NULL,
  `hut04` varchar(20) NOT NULL,
  `hut05` varchar(20) NOT NULL,
  `hut06` varchar(20) NOT NULL,
  `hut07` varchar(20) NOT NULL,
  `blowdown_chambers` varchar(20) NOT NULL,
  `ket_reb` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(1, '2022-06-29', 'normal', 'normal', 'normal', 'normal', 'normal', 'normal', '', '', '', '', '', '', '', '', '', '', '', '', '', 'dsd');
...
CREATE TABLE `water_treatment` (
  `waterintake_p01` varchar(15) NOT NULL,
  `waterintake_02` varchar(30) NOT NULL,
  `rawwater_p01` varchar(30) NOT NULL,
  `rawwater_p02` varchar(30) NOT NULL,
  `sandfilter_p01` varchar(30) NOT NULL,
  `sandfilter_p02` varchar(30) NOT NULL,
  `softener_p01` varchar(30) NOT NULL,
  `softener_p02` varchar(30) NOT NULL,
  `cdp_soda` varchar(30) NOT NULL,
  `cdp_alum` varchar(30) NOT NULL,
  `cdp_pholymer` varchar(30) NOT NULL,
  `tanggal` date NOT NULL,
  `ket` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
