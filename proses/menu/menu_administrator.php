        ...
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="dropdown">
              ...
              data-feather="clock" data-feather="users"></i><span>Data Jadwal Shift</span></a>
              <ul class="dropdown-menu">
                <li><a class="nav-link" href="data_jadwal_shift_administrator.php">Jadwal Shift</a></li>
                <li><a class="nav-link" href="data_shift_administrator.php">Shift</a></li>
               
              </ul>
            </li>
            <li class="dropdown">
              <a href="#" class="menu-toggle nav-link has-dropdown"><i
                  data-feather="users"></i><span>Data Pegawai</span></a>
              <ul class="dropdown-menu">
                <li><a class="nav-link" href="data_bagian_administrator.php">Bagian</a></li>
                <li><a class="nav-link" href="data_divisi_administrator.php">Divisi</a></li>
                <li><a class="nav-link" href="data_jabatan_administrator.php">Jabatan</a></li>
                <li><a class="nav-link" href="data_pegawai_administrator.php">Pegawai</a></li>
              </ul>
            </li>
            <li class="dropdown">
              <a href="data_pengguna_administrator.php"><i
                  data-feather="user-check"></i><span>Data Pengguna</span></a> 
            </li>
            ...
            <li class="dropdown">
              <a href="#" class="menu-toggle nav-link has-dropdown"><i data-feather="copy"></i><span> DATA MAINTENANCE</span></a>
              <ul class="dropdown-menu">
                <li><a class="nav-link" href="breakdown_time.php">Breakdown Time</a></li>
            ...
            <li class="dropdown">
              <a href="#" class="menu-toggle nav-link has-dropdown"><i data-feather="copy"></i><span> DATA K3</span></a>
              <ul class="dropdown-menu">
                <li><a class="nav-link" href="alert.html">Inspection Kantor</a></li>
                <li><a class="nav-link" href="alert.html">Inspection Lab</a></li>
                <li><a class="nav-link" href="alert.html">Inspection Maintenance</a></li>
                <li><a class="nav-link" href="alert.html">Inspection Proses</a></li>
            ...
            <li class="dropdown">
              <a href="#" class="menu-toggle nav-link has-dropdown"><i data-feather="layout"></i><span>Data Informasi</span></a>
              <ul class="dropdown-menu">
                <li><a class="nav-link" href="data_pengaduan_administrator.php">Pengaduan</a></li>
