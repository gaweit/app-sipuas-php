<nav class="navbar navbar-expand-lg main-navbar sticky">
        ...
        <?php
          ...
          $query =mysql_query("SELECT * FROM wtp_lab WHERE status_operator='Selesai' AND wtp_lab.id_user='$id_user' ");/// status menunggu dideklarasikan dengan 0 
            ...
            <div class="dropdown-menu dropdown-list dropdown-menu-right pullDown">
              <div class="dropdown-header">
                ...
                <div class="float-right">
                  <a href="proses_ubah_notifikasi_operator_lab.php?id_wtp">Lihat Data Semua</a>
                </div>
              </div>
          ...
          <ul class="sidebar-menu">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a class="nav-link" href="data_wtp_operator_lab.php">Water Treatment Plant</a></li>
                <li><a class="nav-link" href="data_arsip_operator_lab.php">Arsip Dokumen</a></li>
