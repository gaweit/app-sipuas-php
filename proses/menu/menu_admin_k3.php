...
<div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="dropdown">
              <a href="#" class="menu-toggle nav-link has-dropdown"><i data-feather="copy"></i><span> DATA DIVISI K3</span></a>
              <ul class="dropdown-menu">
                <li><a class="nav-link" href="breakdown_time.php">Inspeksi Kantor</a></li>
                <li><a class="nav-link" href="breakdown_time.php">Inspeksi Proses</a></li>
                <li><a class="nav-link" href="breakdown_time.php">Inspeksi LAB</a></li>
                <li><a class="nav-link" href="breakdown_time.php">Inspeksi Maintenance</a></li>
