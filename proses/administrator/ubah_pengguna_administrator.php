...
?>                    
      ...
      <div class="card">
                  <div class="card-header">
                    <h4>Data Ubah Pengguna</h4>
                  </div>
            <div class="card-body">
                  <form action="proses/administrator/proses_ubah_pengguna_administrator.php" method="POST" enctype="multipart/form-data" >
                  <div class="form-row">
                  ...
                  <div class="form-group col-md-12">
                        ...
                        <input type="text" name="nama" class="form-control"  placeholder="Masukkan Data Nama" value="<?php echo $data['nama']; ?>" required >
                        </div>

                        <div class="form-group col-md-12">
                        <label for="inputEmail4">Username</label>
                        <input type="text" name="username" class="form-control"  placeholder="Masukkan Data Username"value="<?php echo $data['username']; ?>" required >
                        </div>

                        <div class="form-group col-md-12">
                        <label for="inputEmail4">Password</label>
                        <input type="password" name="password" class="form-control"  placeholder="Masukkan Data Password" 
