...
?>
      ...
      <div class="card">
                  ...
                  <h4>Data Tambah TBS Internal</h4>
                  </div>
            <div class="card-body">
                  <form action="proses/administrator/proses_tambah_inter.php" method="POST" enctype="multipart/form-data" >
                  <div class="form-row">
                               ...
                               <div class="form-group col-md-12 col-12">
                                    ...
                                    <input type="date" name="tgl_inter" class="form-control"  placeholder="Masukkan Tanggal" required >
                                </div>
                                ...
                                <div class="form-group col-md-6 col-12">
                                    ...
                                    <textarea type="text" name="ket_inter" class="form-control"  placeholder="Masukkan Data" ></textarea>
                                </div>
