                  ...
                  <div class="form-row">
                               ...
                               <div class="form-group col-md-12 col-12">
                                ...
                                <div class="form-group col-12">
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="tippler_cap_5ton" id="Tidak Normal" value="Tidak Normal">
                                        <label class="form-check-label" for="Tidak Normal">Tidak Normal</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="tippler_cap_5ton" id="Standby" value="Standby">
                                ...
                                <label class="d-block" for="inputEmail4">threser03</label>
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="threser03" id="Tidak Normal6" value="Tidak Normal">
                                ...
                                <label class="d-block" for="inputEmail4">discharge_conveyor01</label>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="discharge_conveyor01" id="Normal7" value="Normal">
                                        <label class="form-check-label" for="Normal7">Normal</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="discharge_conveyor01" id="Tidak Normal7" value="Tidak Normal">
                                        <label class="form-check-label" for="Tidak Normal7">Tidak Normal</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="discharge_conveyor01" id="Standby7" value="Standby">
                                        <label class="form-check-label" for="Standby7">Standby</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="discharge_conveyor01" id="Rusak7" value="Rusak">
                                ...
                                <label class="d-block" for="inputEmail4">discharge_conveyor02</label>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="discharge_conveyor02" id="Normal8" value="Normal">
                                        <label class="form-check-label" for="Normal8">Normal</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="discharge_conveyor02" id="Tidak Normal8" value="Tidak Normal">
                                        <label class="form-check-label" for="Tidak Normal8">Tidak Normal</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="discharge_conveyor02" id="Standby8" value="Standby">
                                        <label class="form-check-label" for="Standby8">Standby</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="discharge_conveyor02" id="Rusak8" value="Rusak">
                                ...
                                <label class="d-block" for="inputEmail4">discharge_conveyor03</label>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="discharge_conveyor03" id="Normal9" value="Normal">
                                        <label class="form-check-label" for="Normal9">Normal</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="discharge_conveyor03" id="Tidak Normal9" value="Tidak Normal">
                                        <label class="form-check-label" for="Tidak Normal9">Tidak Normal</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="discharge_conveyor03" id="Standby9" value="Standby">
                                        <label class="form-check-label" for="Standby9">Standby</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="discharge_conveyor03" id="Rusak9" value="Rusak">
                                ...
                                <label class="d-block" for="inputEmail4">eb_conveyor</label>
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="eb_conveyor" id="Tidak Normal10" value="Tidak Normal">
