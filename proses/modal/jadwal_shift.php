...
<script type="text/javascript">
    ...
    $(document).ready(function()
    {
        $('#tambah').on('show.bs.modal', function(e)
        {
            ...
            {
                url : 'proses/administrator/tambah_jadwal_shift_administrator.php',
    ...
    $(document).ready(function()
    {
        ...
        {
            var idjadwalshift = $(e.relatedTarget).data('id');

            $.ajax( // fungsi ajak untuk mengambil data
            {
                type : 'post',
                url : 'proses/administrator/ubah_jadwal_shift_administrator.php',
                data : 'idjadwalshift='+idjadwalshift,
                success : function(data)
                {
