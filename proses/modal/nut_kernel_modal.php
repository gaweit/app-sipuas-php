...
$(document).ready(function() {
    $('#tambah').on('show.bs.modal', function(e) {
        $.ajax( // fungsi ajak untuk mengambil data
            {
                url: 'proses/administrator/tambah_nut_kernel.php',
...
$(document).ready(function() {
    $('#edit').on('show.bs.modal', function(e) {
        var id_nutkernel = $(e.relatedTarget).data('id');

        $.ajax( // fungsi ajak untuk mengambil data
            {
                type: 'post',
                url: 'proses/administrator/ubah_nut_kernel.php',
                data: 'id_nutkernel=' + id_nutkernel,
                success: function(data) {
