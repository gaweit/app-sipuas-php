...
$(document).ready(function() {
    $('#tambah').on('show.bs.modal', function(e) {
        $.ajax( // fungsi ajak untuk mengambil data
            {
                url: 'proses/administrator/tambah_klarifikasi.php',
...
$(document).ready(function() {
    $('#edit').on('show.bs.modal', function(e) {
        var id_klarifikasi = $(e.relatedTarget).data('id');

        $.ajax( // fungsi ajak untuk mengambil data
            {
                type: 'post',
                url: 'proses/administrator/ubah_klarifikasi.php',
                data: 'id_klarifikasi=' + id_klarifikasi,
                success: function(data) {
