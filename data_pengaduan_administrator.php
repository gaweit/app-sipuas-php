...
<body>
                  ...
                  <div class="card-body">
                    ...
                    <div class="table-responsive">
                      ...
                      <thead>
                                    ...
                                    <?php
                                                    $query = mysql_query("SELECT * FROM pengaduan ORDER BY id_pengaduan asc");
                                                $no = 1;
  ...
  <a  href="#" onclick="confirm_modal('proses/administrator/hapus_pengaduan_administrator.php?id=<?php echo $data['id_pengaduan'];?>');">
...
<?php include("proses/modal/bagian.php");?>
