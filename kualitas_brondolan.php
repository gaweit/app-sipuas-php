              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h4>Tabel Data Kualitas Brondolan</h4>
                  </div>
                    ...
                    <button class="btn btn-icon btn-info" data-toggle="modal" data-target="#tambah">
                      ...
                      <thead>
                                        <tr>
                                            <th>No</th>
                                            <th>Tanggal</th>
                                            <th>Brondolan to TBS</th>
                                            <th>Brondolan Segar</th>   
                                            <th>Brondolan Busuk</th>                               
                                            <th>Sampah</th>
                                            <th>Keterangan</th>
                                            <th>Aksi</th>
                                    ...
                                    <?php
                                                    ...
                                                    $query = mysql_query("SELECT * FROM kualitas_brondolan ORDER BY tgl_kb ASC");
                                                $no = 1;
                                    ...
                                    <tbody>
                                        <tr>
                                                <td> <?php echo $no++ ?></td> 
                                                <td> <?php echo $data['tgl_kb']; ?></td>
                                                <td> <?php echo $data['to_tbs']; ?> %</td>
                                                <td> <?php echo $data['segar']; ?> %</td>
                                                <td> <?php echo $data['busuk']; ?> %</td>
                                                <td> <?php echo $data['sampah']; ?> %</td>
                                                <td> <?php echo $data['ket_kb']; ?></td>
                                               
                                                <td class="td-actions text-center">
                                                         <a  href ="#edit" data-toggle="modal" data-id="<?php echo $data['id_kb'];?>" 
                                                         data-target="#edit"><button type="button" rel="tooltip" class="btn btn-icon btn-success">
                                                            <i class="fa fa-edit"> Ubah</i>
                                                        </button></a>
                                                     
  <a  href="#" onclick="confirm_modal('proses/administrator/hapus_kb.php?id=<?php echo $data['id_kb'];?>');">
